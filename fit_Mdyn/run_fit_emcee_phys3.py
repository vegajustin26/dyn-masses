...
datafile = 'phys3_std_medr_medv_noiseless'
#ext = '_wide1'


# velocity range to fit
vlo, vhi = -5., 5.	# low and high LSRK velocities to fit [km/s]

censor = False
#vclo, vchi = 3.9, 5.9    # case 2
#vclo, vchi = 3.0, 5.0    # case 3
#vclo, vchi = 1.5, 6.5    # case 4
...
# initialize walkers
p_lo = np.array([ 30, 120, 0.2, 150,   0,  0.5,  10,
                 0.2,   5, 10, -1.0, -0.2, -0.2])
p_hi = np.array([ 50, 140, 1.0, 550,   5,  1.5,  100,
                 0.8,  30, 250, 1.0,  0.2,  0.2])

# # initialize walkers
# p_lo = np.array([ 30, 120, 0.2, 150,   0,  0.5,  155,
#                  0.2,   5, 300, 3.5, -0.1, -0.1])
# p_hi = np.array([ 50, 140, 1.0, 550,   5,  1.5,  455,
...
def lnprob(theta):
    ...
    ptheta[10] = lnpU(theta[10], -1.0, 1.0)
...
### -----------------------
filename = 'posteriors/'+datafile+'2.h5'
