...
# fitsfile = 'simp5_std_medr_lowv_noisy.uvfits'
# fitsfile1 = 'simp5_std_medr_lowv_noiseless.uvfits'
# npzfile = 'std_medr_lowv10x.freq_conversions.npz'
# wwwfits = 'https://www.cfa.harvard.edu/~sandrews/data/'
#
# import urllib.request
# if not os.path.exists(wdir+'fake_data/sim_uvfits/'+fitsfile):
#     print('Downloading UVFits...')
#     urllib.request.urlretrieve(wwwfits+fitsfile, wdir+'fake_data/sim_uvfits/'+fitsfile)
# if not os.path.exists(wdir+'fake_data/sim_uvfits/'+fitsfile1):
#     print('Downloading UVFits...')
#     urllib.request.urlretrieve(wwwfits+fitsfile1, wdir+'fake_data/sim_uvfits/'+fitsfile1)
# if not os.path.exists(wdir + 'fake_data/template_params/'+npzfile):
#     print('Downloading NPZ file...')
#     urllib.request.urlretrieve(wwwfits+npzfile, wdir+'fake_data/template_params/'+npzfile)
...
datafile = 'simp5_std_medr_lowv_noiseless'
...
template_name = 'std_medr_lowv10x'
...
# FOV, dist, Npix, Tbmax, r0 = 8.0, 150., 256, 1000., 10.
#
# # initialize walkers
# p_lo = np.array([ 30, 120, 1.0, 150,   0,  0.5,  155,
#                  0.2,   5, 300, 3.5, -0.1, -0.1])
# p_hi = np.array([ 50, 140, 3.0, 550,   5,  1.5,  455,
#                  0.8,  30, 600, 4.5,  0.1,  0.1])
